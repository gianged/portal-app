...
pub const TEXT_DISPLAY: &str = "26px";
pub const TEXT_H1: &str = "28px";
pub const TEXT_H2: &str = "20px";
pub const TEXT_H3: &str = "16px";
pub const TEXT_LEAD: &str = "14.5px";
pub const TEXT_BODY: &str = "14px";
pub const TEXT_SMALL: &str = "13.5px";
pub const TEXT_LABEL: &str = "13px";
pub const TEXT_CAPTION: &str = "12.5px";
pub const TEXT_BADGE: &str = "12px";
pub const TEXT_EYEBROW: &str = "11.5px";
pub const TEXT_TINY: &str = "11.5px";
pub const TEXT_COUNT: &str = "11px";
pub const TEXT_MICRO: &str = "10px";
